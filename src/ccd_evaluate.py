...
def ccd_evaluate_llm(k_shot, source, target, data_info, model_name, rating_ranking, injection, prompt_context):
    ...
    client = OpenAI(api_key=os.getenv('OPENAI_API_KEY'), base_url="http://localhost:4000/v1")
